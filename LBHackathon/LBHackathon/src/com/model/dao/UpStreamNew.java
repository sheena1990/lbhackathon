package com.model.dao;
	...
	public abstract class UpStreamNew {
	  ...
	  public UpStreamNew(String apiKey, String senderId, String serviceName) {
	    ...
	    stanzaFilter = new StanzaFilter() {
	      ...
	      public boolean accept(Stanza stanza) {
	        // Accept messages from GCM CCS.
	    	  System.out.println("Accpet stanza");
	    ...
	    stanzaListener = new StanzaListener() {
	      ...
	      System.out.println("stanzaListener");
